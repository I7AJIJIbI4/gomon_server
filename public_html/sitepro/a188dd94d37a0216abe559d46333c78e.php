...
<body class="site site-lang-uk<?php if (isset($wbPopupMode) && $wbPopupMode) echo ' popup-mode'; ?> " <?php ?>><div id="wb_root" class="root wb-layout-vertical"><div class="wb_sbg"></div><div id="map-container"></div>
    ...
    </script><!-- Подключаем Google Maps JavaScript API с вашим ключом --><script src="https://maps.googleapis.com/maps/api/key=AIzaSyAxc4PFbSvV5DWckMIPOCsZzdldmqxqB8w&amp;callback=initMap" async defer>
