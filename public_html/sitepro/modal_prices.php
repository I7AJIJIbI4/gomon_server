...
// Allow: whitelisted Origin, whitelisted Referer, or same-origin browser fetch (Sec-Fetch-Site)
$is_allowed = in_array($origin_host, $allowed) || in_array($referer_host, $allowed) || $sec_fetch === 'same-origin';
if (!$is_allowed) {
