...
<section class="hero" id="hero">
  ...
  <div class="hero-content">
    ...
    <p class="hero-desc">Лікар із 7+ років досвіду та амбасадор природніх ін'єкцій.<br>Відмовимо від зайвого — підберемо лише те, що потрібне.<br>Поруч — Анастасія Цвіткова, майстер DrumRoll та фігури.</p>
    <div class="cta-group">
