...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero-desc { font-size: 17px; font-weight: 300; color: var(--text-light); line-height: 1.8; margin-bottom: 24px; max-width: 480px; margin-left: auto; margin-right: auto; text-align: justify; opacity: 0; animation: fadeUp 0.8s 0.8s ease forwards; }
...
<section class="hero" id="hero">
  ...
  <div class="hero-content">
    ...
    <p class="hero-desc">Вікторія Гомон-Павловська — лікар із 7+ роками досвіду та амбасадор природніх ін'єкцій. Відмовимо від зайвого, підберемо те, що дійсно потрібно. Поруч — Анастасія Цвіткова, майстер DrumRoll та корекції фігури.</p>
    <div class="cta-group">
