    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "itemOffered": {
          ...
          "description": "Контурна пластика губ та обличчя, біоревіталізація, мезотерапія, ліфтинг"
        },
        "priceCurrency": "UAH",
        "price": "1400",
        "priceSpecification": {
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Які послуги надає косметолог Dr. Gomon в Черкасах?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Dr. Gomon Cosmetology пропонує повний спектр косметологічних послуг: WOW-чистка обличчя, збільшення губ, ін'єкційна косметологія, біоревіталізація, мезотерапія, пілінги, апаратний масаж DrumRoll, пресотерапія, косметичне відбілювання зубів Magic Smile. Актуальні ціни — на сайті та в мобільному додатку."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Так, лікар Вікторія проводить індивідуальні консультації (офлайн та онлайн). На консультації оцінюється стан шкіри, підбирається план процедур, обговорюються побажання та протипоказання. Детальніше — на сайті або в мобільному додатку."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "DrumRoll — це апаратний масаж з ударно-імпульсним вакуумом та інфрачервоним теплом. Ефективний при болях у спині, м'язовій втомі, набряках. Доступні варіанти: моделювання окремої ділянки, моделювання всього тіла, релакс-масаж. Також пресотерапія для лімфодренажу та зняття важкості в ногах."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Так! WOW-чистка обличчя — глибоке очищення комбінацією апаратних та мануальних технік. Підходить для всіх типів шкіри, особливо жирної та комбінованої з розширеними порами. Є класична WOW-чистка, WOW-чистка «Сяяння» з ефектом освітлення та підліткова делікатна чистка."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Так, косметичне відбілювання зубів Magic Smile — безпечна система без болю та пошкодження емалі. Три варіанти інтенсивності: Light (1 засвічування), Medium (2 засвічування), Maximum (3 засвічування). Чим більше засвічувань — тим яскравіший результат."
      }
    }
  ]
}
