...
if ($source === 'site') {
    ...
    $system_prompt .= "\n\n---\n## Контекст: Додаток Dr. Gomon (PWA)\nТи вбудований асистент у мобільному додатку. Для запису або консультації з лікарем — направляй в [Instagram Direct](https://ig.me/m/dr.gomon) або [Telegram](https://t.me/DrGomonCosmetology). Також можна зателефонувати 073-310-31-10.";
}
