...
ADMIN_ACTION_PATTERNS = [
    ...
    'є остання',
    'Ваш запис на завтра',  # підтвердження часу з CRM/календаря
...
- Підтверджувати або скасовувати записи в CRM-системі
- Виставляти рахунки або проводити платежі WayForPay
- Перевіряти наявність слотів у календарі лікаря
