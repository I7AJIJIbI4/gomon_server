...
SYSTEM_PROMPT_FILE = '/opt/gomon/app/system_prompt.txt'
...
def _build_system_prompt(client_phone=None):
    ...
    prompt += ('\n\n---\n## Контекст: Telegram Business (DM з @DrGomonCosmetologyBot)'
               ...
               '\n\nВАЖЛИВО: Клієнт вже в Telegram — НІКОЛИ не давай посилання на Instagram, Telegram або телефон для зв\'язку. '
